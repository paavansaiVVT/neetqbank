...
from tutor_bots.jee_chapter_bot import tools,llm
...
response = requests.get(os.getenv("JEE_COMMON_BOT_PROMPT"))
...
async def model_call(agent_executor, messages:list):
    try:
