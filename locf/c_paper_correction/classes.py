...
# Legacy required items (for backward compatibility)
required_items =["section", "question_number", "student_answer_text", "feedback", "maximum_marks", "marks_awarded", "confident_level"]

# Required fields from OCR_Answer_Sheet_Grader_Agent (grading output)
required_grading_output_fields = [
    "section",
    "question_number",
    "student_answer_text",
    "feedback",
    "maximum_marks",
    "marks_awarded",
    "confident_level"  # Note: keeping existing typo for backward compatibility
]

# Optional fields (can be null)
optional_grading_fields = [
    "actual_answer",  # Can be null for some question types
    "section"  # Can be null if section not determined
]
